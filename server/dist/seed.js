...
async function seed() {
    ...
    await models_1.Merchant.deleteMany({});
    await models_1.Customer.deleteMany({});
    await models_1.Transaction.deleteMany({});
    await models_1.Campaign.deleteMany({});
    await models_1.StrategyMemory.deleteMany({});
    console.log('Cleared existing data.');
    // 1. Seed Merchant
    const merchant = await models_1.Merchant.create({
    ...
    await (0, tenant_1.runWithTenant)(MERCHANT_ID, async () => {
        ...
        await models_1.Customer.create(customerData);
        ...
        await models_1.Transaction.create(transactions);
        console.log(`Seeded ${transactions.length} transactions.`);
        // 4. Seed Historical Campaign & Strategy Memory
        const historicalCampaign = await models_1.Campaign.create({
